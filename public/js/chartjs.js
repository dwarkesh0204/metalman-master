...
$(window).on("load", function () {
    ...
    var chartOptions = {
        ...
        scales: {
            ...
            yAxes: [{
                ...
                scaleLabel: {
                    display: true,
                    labelString: 'Foot Fall Count (Bar)'
                }
            }]
        },
    ...
    // Chart Data
    var chartData = {
        labels: ["12 Mid Night", "1 am", "2 am", "3 am", "4 am", "5 am", "6 am", "7 am", "8 am", "9 am", "10 am", "11 am", "12 noon", "1 pm", "2 pm", "3 pm", "4 pm", "5 pm", "6 pm", "7 pm", "8 pm", "9 pm", "10 pm", "11 pm"],
        datasets: [{
            label: "Expected Visitors",
            data: [0, 1, 1, 2, 1, 0, 0, 1, 0, 1, 2, 1, 1, 2, 1, 0, 1, 2, 0, 1, 0, 1 ,3 ,2],
            fill: false,
            borderColor: "#9C27B0",
