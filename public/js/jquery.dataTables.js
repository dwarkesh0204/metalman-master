...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlLength ( settings )
	{
		...
		var select = $('<select/>', {
			...
			'class':         classes.sLengthSelect +' selectpicker',
			'style':         'display:none',
		} );
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			...
			"oPaginate": {
				 ...
				 *    } );
				 */
				"sNext": "Next"+' <i class="fa fa-arrow-right" aria-hidden="true"></i>',
				 ...
				 *    } );
				 */
				"sPrevious": '<i class="fa fa-arrow-left" aria-hidden="true"></i> '+"Previous"
			},
