      ...
      <div class="col-md-4">
        <div class="card">
          ...
          <div class="card-body">
            ...
            @if(count($currentVisitorData) > 0)
                @foreach($currentVisitorData as $currentVisitor)
                    <div class="list-group-item bg-lighten-5">
                        <span class="media">
                            <span class="avatar avatar-md avatar-online">
                                <img class="media-object d-flex mr-3 bg-primary height-50 rounded-circle" src="app-assets/img/portrait/small/avatar-s-3.png" alt="Generic placeholder image"> <i></i>
                            </span>
                            <div class="media-body">
                                <h6 class="list-group-item-heading">{{ $currentVisitor->user_name }} <span class="font-small-3 float-right dark-blue">4:14 AM</span> </h6>
